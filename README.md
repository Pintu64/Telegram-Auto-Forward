...
- `Copy` is the default: the target post looks like you posted it, with no "Forwarded from" header.
- `Forward` keeps Telegram attribution if you turn it on in Delivery mode.
